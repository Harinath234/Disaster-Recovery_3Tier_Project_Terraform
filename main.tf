...
##### setup NETWORK IN n.v (us-east-1)
...
# # Module: Security Groups  IN n.v (us-east-1)
...
# # Module: Primary Load Balancers IN n.v (us-east-1)
module "alb" {
...
module "launch_templates" {
 ...
 #ami_id_frontend     = "ami-0eec7485a34edc3b8"
  ami_id_frontend     = "ami-0702f87daba5be411"
 #ami_id_backend      = "ami-0084f9ebbb4f07bcd"
  ami_id_backend      = "ami-0b03a5625363bf260"
